...
class IMUSensor{
  ...
  private:
	void calcDataMPU(); // user should better call 'update' that 
	void calcDataQMC(); // user should better call 'update' that 
	void calcDataBMP(); // user should better call 'update' that 
